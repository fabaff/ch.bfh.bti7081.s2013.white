...
public class EditDiagnosisComponent extends PmsComponentController implements
	...
	private class SaveDiagnosisButtonListener implements Button.ClickListener {
		...
		private void updateDiagnosis() throws CommitException,
				UnknownUserException {
			EditDiagnosisComponent.this.fieldGroup.commit();

			BeanItem<Diagnosis> beanItem = EditDiagnosisComponent.this.fieldGroup
					.getItemDataSource();
			if (beanItem != null) {
	...
	public EditDiagnosisComponent() {
		...
		// Static UI elements
		//this.lblView.setValue("Diagnose bearbeiten");
	...
	public void setNewItem(boolean value) {
		...
		this.lblView.setValue(value ? TITLE_NEW_DIAGNOSIS
	...
	public void enter(ViewChangeEvent event) {
		try {
			if (this.isNewDiagnosis) {
				Diagnosis diag = new Diagnosis(PmsDataAccessCreator
						.getDataAccess().getPCaseContainer().getCurrentItem());
				diag.setNewDiagnosis();
				this.bindFields(diag);
			} else {
	...
	private AbsoluteLayout buildMainLayout() {
		...
		lblView.setValue("Neue Diagnose");
