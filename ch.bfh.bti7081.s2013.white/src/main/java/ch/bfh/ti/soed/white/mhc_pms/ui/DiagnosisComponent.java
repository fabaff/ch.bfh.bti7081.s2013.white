...
class DiagnosisComponent extends PmsComponentController implements
	...
	public DiagnosisComponent() {
		...
		this.lblView.setValue("Übersicht Diagnosen");
	}
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(btnNewDiagnosis, "top:20.0px;left:250.0px;");
		...
		mainLayout.addComponent(btnEditDiagnosis, "top:20.0px;left:380.0px;");
		...
		mainLayout.addComponent(btnDeleteDiagnosis, "top:20.0px;left:530.0px;");
