...
class TitleBarComponent extends PmsComponentController implements PmsComponentListener,
	...
	public void pCaseItemChange(Object itemId) {
		...
		this.lblFirstName.addStyleName(Reindeer.LABEL_H2);
		this.lblFirstName.setValue(item.getFirstName());
		this.lblLastName.addStyleName(Reindeer.LABEL_H2);
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(lblFirstName, "top:18.0px;left:20.0px;");
		...
		mainLayout.addComponent(lblLastName, "top:18.0px;left:160.0px;");
