...
public class NewPatientComponent extends PmsComponentController {
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(txtReligion, "top:100.0px;left:220.0px;");
		...
		mainLayout.addComponent(txtAddress, "top:160.0px;left:20.0px;");
		...
		mainLayout.addComponent(txtPhonePrivate, "top:220.0px;left:20.0px;");
		...
		mainLayout.addComponent(txtEmail, "top:220.0px;left:620.0px;");
		...
		mainLayout.addComponent(txtPhoneBusiness, "top:220.0px;left:220.0px;");
		...
		mainLayout.addComponent(txtMobilePhone, "top:220.0px;left:420.0px;");
		...
		mainLayout.addComponent(txtCountry, "top:160.0px;left:620.0px;");
		...
		mainLayout.addComponent(txtHomeLocation, "top:160.0px;left:420.0px;");
		...
		mainLayout.addComponent(txtPostalCode, "top:160.0px;left:220.0px;");
		...
		mainLayout.addComponent(cmbCivilStatus, "top:100.0px;left:420.0px;");
