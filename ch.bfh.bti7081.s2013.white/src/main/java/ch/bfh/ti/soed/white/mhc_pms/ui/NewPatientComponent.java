...
public class NewPatientComponent extends PmsComponentController {
	...
	private AbsoluteLayout buildMainLayout() {
		...
		// panPerInfo
		panPerInfo = buildPanPerInfo();
		mainLayout.addComponent(panPerInfo, "top:20.0px;left:18.0px;");
		...
		// panFam
		panFam = buildPanFam();
		mainLayout.addComponent(panFam, "top:369.0px;left:20.0px;");
	...
	@AutoGenerated
	private Panel buildPanPerInfo() {
		// common part: create layout
		panPerInfo = new Panel();
		panPerInfo.setCaption("Persönliche Angaben");
		panPerInfo.setImmediate(false);
		panPerInfo.setWidth("-1px");
		panPerInfo.setHeight("-1px");
		
		// verticalLayout_2
		verticalLayout_2 = buildVerticalLayout_2();
		panPerInfo.setContent(verticalLayout_2);
	...
	@AutoGenerated
	private Panel buildPanFam() {
		// common part: create layout
		panFam = new Panel();
		panFam.setCaption("Angehörige");
		panFam.setImmediate(false);
		panFam.setWidth("-1px");
		panFam.setHeight("-1px");
		
		// verticalLayout_4
		verticalLayout_4 = buildVerticalLayout_4();
		panFam.setContent(verticalLayout_4);
