...
class MedicationComponent extends PmsComponentController implements PmsComponentListener {
	...
	public MedicationComponent() {
		...
		this.btnNewMedication.setEnabled(permission.hasPermission(Operation.NEW_MEDICATION));
		this.btnEditMedication.setEnabled(permission.hasPermission(Operation.EDIT_MEDICATION));
		this.btnDeleteMedication.setEnabled(permission.hasPermission(Operation.DELETE_MEDICATION));
