...
class PatientInfoComponent extends PmsComponentController implements PmsComponentListener {
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(lblCommuncationLanguage, "top:80.0px;left:180.0px;");
		...
		btnEditPatient.setImmediate(false);
		btnEditPatient.setWidth("-1px");
		btnEditPatient.setHeight("-1px");
		mainLayout.addComponent(btnEditPatient, "top:20.0px;left:150.0px;");
