...
class PatientInfoComponent extends PmsComponentController implements PmsComponentListener {
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(panel_1, "top:60.0px;left:480.0px;");
		
		// panel_2
		panel_2 = buildPanel_2();
		mainLayout.addComponent(panel_2, "top:60.0px;left:320.0px;");
		
		// panel_3
		panel_3 = buildPanel_3();
		mainLayout.addComponent(panel_3, "top:60.0px;left:20.0px;");
		
		// panel_4
		panel_4 = buildPanel_4();
		mainLayout.addComponent(panel_4, "top:60.0px;left:160.0px;");
		
		// label_2
		label_2 = new Label();
		label_2.setCaption("Nationalität: ");
		label_2.setImmediate(false);
		label_2.setWidth("-1px");
		label_2.setHeight("-1px");
		label_2.setValue("Label");
		mainLayout.addComponent(label_2, "top:80.0px;left:500.0px;");
		
		// label_3
		label_3 = new Label();
		label_3.setCaption("Verständigung: ");
		label_3.setImmediate(false);
		label_3.setWidth("-1px");
		label_3.setHeight("18px");
		label_3.setValue("Label");
		mainLayout.addComponent(label_3, "top:80.0px;left:180.0px;");
