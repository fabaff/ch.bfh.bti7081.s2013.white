...
class PatientInfoComponent extends PmsComponentController implements PmsComponentListener {
	...
	public PatientInfoComponent() {
		...
		PmsPermission permission = new PmsPermission(this.pmsDataAccess.getCurrentUser().getUserGroup());
		this.btnNewPatient.setEnabled(permission.hasPermission(Operation.NEW_PATIENT));
