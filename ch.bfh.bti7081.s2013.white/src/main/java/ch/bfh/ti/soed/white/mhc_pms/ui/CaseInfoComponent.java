...
class CaseInfoComponent extends CustomComponent {
	 ...
	 * editor.
	 */
	public CaseInfoComponent(ImhcPmsComponent mainComponent) {
		buildMainLayout();
...
//		}
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(btnEditCaseData, "top:220.0px;left:20.0px;");
		...
		mainLayout.addComponent(btnNewCase, "top:220.0px;left:180.0px;");
		...
		mainLayout.addComponent(lblZuweiser, "top:40.0px;left:200.0px;");
		...
		mainLayout.addComponent(lblSuizidal, "top:40.0px;left:380.0px;");
		...
		mainLayout.addComponent(lblPatVerfuegung, "top:160.0px;left:20.0px;");
		...
		mainLayout.addComponent(lblUrlaub, "top:100.0px;left:200.0px;");
		...
		mainLayout.addComponent(lblAusgang, "top:100.0px;left:20.0px;");
		...
		mainLayout
				.addComponent(lblDateCaseOpended, "top:160.0px;left:200.0px;");
		...
		mainLayout.addComponent(lblDateCaseClosed, "top:160.0px;left:380.0px;");
		...
		mainLayout
				.addComponent(lblFremdgefaehrtung, "top:40.0px;left:560.0px;");
