...
class PatientProgressComponent extends PmsComponentController implements PmsComponentListener {
	...
	public PatientProgressComponent() {
		...
		this.btnNewPatientProgressEntry.setEnabled(permission.hasPermission(Operation.NEW_PATIENT_PROGRESS_ENTRY));
		this.btnEditPatientProgressEntry.setEnabled(permission.hasPermission(Operation.EDIT_PATIENT_PROGRESS_ENTRY));
		this.btnDeletePatientProgressEntry.setEnabled(permission.hasPermission(Operation.DELETE_PATIENT_PROGRESS_ENTRY));
	}
