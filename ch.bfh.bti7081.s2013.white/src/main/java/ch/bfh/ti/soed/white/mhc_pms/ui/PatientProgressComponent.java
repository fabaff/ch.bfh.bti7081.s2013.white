...
//		this.btnDeletePatientProgressEntry.setEnabled(permission.isDeletePatientProgressEntryAllowed());
	...
	private AbsoluteLayout buildMainLayout() {
		...
		btnNewPatientProgressEntry.setImmediate(false);
		btnNewPatientProgressEntry.setWidth("-1px");
		...
		btnEditPatientProgressEntry.setImmediate(false);
		btnEditPatientProgressEntry.setWidth("-1px");
		btnEditPatientProgressEntry.setHeight("-1px");
		mainLayout.addComponent(btnEditPatientProgressEntry,
				"top:20.0px;left:160.0px;");
		...
		btnDeletePatientProgressEntry.setImmediate(false);
