...
class PatientTableComponent extends PmsComponent {
	...
	public PatientTableComponent() {
				...
				.addValueChangeListener(new Property.ValueChangeListener() {
					...
					public void valueChange(ValueChangeEvent event) {
						if (event.getProperty().getValue() != null) {
							PatientTableComponent.this.firePCaseItemChangeEvent(PatientTableComponent.this.tblPatients.getValue());
						}
					}
				});
		...
		this.btnNewCase.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				// Component detail =
				// PatientTableComponent.this.mainComponent.getEditCaseInfoComponent();
