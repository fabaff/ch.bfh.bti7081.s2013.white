...
class PatientTableComponent extends CustomComponent {
	...
	public void updateComponentDataSource() {
		...
		//this.tblPatients.select(MhcPmsDataAccess.getInstance().getCurrentContainer(Patient.class).getCurrentItem().getId());
		this.tblPatients.select(((Patient) MhcPmsDataAccess.getInstance().getCurrentContainer(Patient.class).getCurrentItem()).getId());
	}
