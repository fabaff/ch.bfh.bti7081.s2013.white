...
/**
 * This listener will be notified if a component will navigate to an other component. The observer pattern will be used.
 * 
...
public interface ComponentChangeListener {
	 ...
	 * 
	 * @param event specifies the navagtion target
	 */
