 ...
 */
public class EditCaseInfoComponent extends PmsComponentController implements NewItemListener {
	...
	private class SaveButtonListener implements Button.ClickListener {
		...
		public void buttonClick(ClickEvent event) {
			try {
                ...
                Notification.show("Geänderter Fall gespeichert", Notification.Type.HUMANIZED_MESSAGE);
