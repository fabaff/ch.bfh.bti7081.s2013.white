...
public class EditCaseInfoComponent extends PmsComponentController {
	...
	private EntityItem<PCase> newCaseItem;
	...
	private void bindFields() {
		...
		this.newCaseItem = this.dataAccess.getPCaseContainer().getItem(
				this.dataAccess.getCurrentPCaseId());

		if (this.newCaseItem != null) {
...
//					// TODO bessere Trennung Model und View
//					if (!EditCaseInfoComponent.this.dataAccess
//							.isNewCaseActivated()) {
//						// EditCaseInfoComponent.this.newCaseItem =
//						// EditCaseInfoComponent.this.dataAccess.getPCaseContainer().
//						// getItem(EditCaseInfoComponent.this.dataAccess.getCurrentPCaseId());
//						// EditCaseInfoComponent.this.newCaseItem.getEntity().setPcid(0);
//						BeanItem<PCase> beanItem = new BeanItem<PCase>(
//								EditCaseInfoComponent.this.newCaseItem
//										.getEntity());
//						
//					} else {
//
//						// TODO openDate init
//						// TODO Fall abschliessen bei neuem FAll (abschlussdate
//						// und fall abgeschl. speichern)
//						// TODO BeanItemGroup verwenden
//
//						id = EditCaseInfoComponent.this.dataAccess
...
//					id = EditCaseInfoComponent.this.dataAccess
//							.getPCaseContainer().addEntity(new PCase(EditCaseInfoComponent.this.dataAccess.getUser()));
					
					BeanItem<PCase> beanItem = new BeanItem<PCase>(
					EditCaseInfoComponent.this.newCaseItem
							.getEntity());
					beanItem.getBean().setPcid(0);
					id = EditCaseInfoComponent.this.dataAccess
					.getPCaseContainer().addEntity(beanItem.getBean());
