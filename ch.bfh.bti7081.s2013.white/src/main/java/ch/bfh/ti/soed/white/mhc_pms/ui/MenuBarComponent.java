...
import ch.bfh.ti.soed.white.mhc_pms.security.UserFactory;
...
public class MenuBarComponent extends CustomComponent {
	...
	private class MenuBarButtonListener implements Button.ClickListener {
		...
		public void buttonClick(ClickEvent event) {
			...
			MenuBarComponent.this.mhcPmsUI.setActiveComponents(comp[0], comp[1]);
		}
	 ...
	 * @param mhcPmsMainUI 
	 */
	public MenuBarComponent(ImhcPmsUI mhcPmsUI) {
		buildMainLayout();
		setCompositionRoot(mainLayout);

		this.mhcPmsUI = mhcPmsUI;
		...
		this.btnBack.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				UserFactory.getUser().decrementPatient();
			}
		});
		...
		this.btnForward.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				UserFactory.getUser().incrementPatient();
			}
		});
	}

	public void addTab(ButtonEnum btnEnum, Component title, Component main) {
