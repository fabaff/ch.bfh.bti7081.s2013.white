...
class MenuBarComponent extends PmsComponentController implements
	...
	public MenuBarComponent(final Navigator navigator) {
		...
		try {
			...
			this.lblDate.setValue(DateFormat.getDateInstance(DateFormat.LONG)
					.format(new Date()));

			this.addListeners(navigator);
	...
	private void addListeners(final Navigator navigator) {
	...
	private void addForwardButtonClickListener() {
		this.btnForward.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				Object id = MenuBarComponent.this.pmsDataAccess
						.getPCaseContainer().incrementCurrentItemId();
				if (id != null) {
	...
	private void addBackButtonClickListener() {
		this.btnBack.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				Object id = MenuBarComponent.this.pmsDataAccess
						.getPCaseContainer().decrementCurrentItemId();
				if (id != null) {
					MenuBarComponent.this.firePCaseItemChangeEvent();
				}
			}
	...
	private AbsoluteLayout buildMainLayout() {
		...
		btnForward.setWidth("50px");
		btnForward.setHeight("-1px");
		mainLayout.addComponent(btnForward, "top:460.0px;left:80.0px;");
		...
		mainLayout.addComponent(lblTitle, "top:20.0px;left:10.0px;");
