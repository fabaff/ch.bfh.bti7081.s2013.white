...
class MenuBarComponent extends PmsComponentController implements
	...
	private AbsoluteLayout buildMainLayout() {
		...
		btnForward.setWidth("100.0%");
		btnForward.setHeight("-1px");
		mainLayout.addComponent(btnForward,
				"top:460.0px;right:10.0px;left:80.0px;");
		...
		lblTitle.setValue("app_title");
		mainLayout.addComponent(lblTitle, "top:10.0px;left:20.0px;");
		...
		lblDate.setValue("data");
		mainLayout.addComponent(lblDate, "top:50.0px;left:30.0px;");
