...
class MenuBarComponent extends PmsComponentController implements UIActivationListener {
	...
	private void addButtonListeners(final Navigator navigator) {
		...
		this.btnBack.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				Object id = MenuBarComponent.this.dataAccess.decrementCurrentPCaseItemId();
				if (id != null) {
		...
		this.btnForward.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				Object id = MenuBarComponent.this.dataAccess.incrementCurrentPCaseItemId();
				if (id != null) {
					MenuBarComponent.this.firePCaseItemChangeEvent(id);
				}
			}
