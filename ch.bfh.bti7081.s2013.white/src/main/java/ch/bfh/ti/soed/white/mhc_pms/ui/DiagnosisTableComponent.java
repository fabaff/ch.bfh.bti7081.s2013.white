...
class DiagnosisTableComponent extends PmsComponentController implements
	...
	private void initDiagnosisTable() {
		this.tblDiagnosis.setContainerDataSource(this.pmsDataAccess
	...
	private void setPermissions(Object itemId) {
		Diagnosis currentDiag = this.pmsDataAccess.getDiagnosisContainer().getCurrentItem();
		...
		this.btnEditDiagnosis.setEnabled(this.permission
				.hasPermission(Operation.EDIT_DIAGNOSIS) && itemId != null && isOpen);
		this.btnDeleteDiagnosis.setEnabled(this.permission
				.hasPermission(Operation.DELETE_DIAGNOSIS) && itemId != null && isOpen);
	}

	@Override
	public void enter(ViewChangeEvent event) {
		this.setPermissions(this.pmsDataAccess.getDiagnosisContainer()
				.getCurrentItemId());
