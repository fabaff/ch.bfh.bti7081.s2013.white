...
class DiagnosisTableComponent extends PmsComponentController implements
	...
	public DiagnosisTableComponent() {
		...
		this.setPermissions(this.pmsDataAccess.getDiagnosisContainer().getCurrentItemId());
	...
	private void addValueChangeListener() {
		this.tblDiagnosis.addValueChangeListener(new Property.ValueChangeListener() {
...
//					Object id = DiagnosisTableComponent.this.tblDiagnosis.getValue();
...
//					PatientTableComponent.this.firePCaseItemChangeEvent();
				...
				DiagnosisTableComponent.this.setPermissions(event.getProperty().getValue());
			}
		});
	}
	...
	private void setPermissions(Object id) {
		this.btnNewDiagnosis.setEnabled(this.permission
				.hasPermission(Operation.NEW_DIAGNOSIS));
		this.btnEditDiagnosis.setEnabled(this.permission
				.hasPermission(Operation.EDIT_DIAGNOSIS) && id != null);
		this.btnDeleteDiagnosis.setEnabled(this.permission
				.hasPermission(Operation.DELETE_DIAGNOSIS) && id != null);
	}

	@Override
	public void pCaseItemChange() {
		this.pmsDataAccess.getDiagnosisContainer().setCurrentItemFilter(this.pmsDataAccess.getPCaseContainer().getCurrentItemId());
		Object diagnosisItemId = this.pmsDataAccess.getDiagnosisContainer().getCurrentItemId();
